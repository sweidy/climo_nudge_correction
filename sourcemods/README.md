Included are sourcemod changes to CESM2.1.5 for running the climatological nudging with integrated control. 
...
- cime_config: addition of compsets used for the climatological SST nudging case referenced in the paper (F2000_DARTC6) used to test sensitivity to SST forcing during the tendency generation step. 
